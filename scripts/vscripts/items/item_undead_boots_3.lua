...
--------------------------------------------------------------------------------
function item_undead_boots_3:PlayEffects( origin, direction )
	-- Get Resources
