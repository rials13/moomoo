...
--------------------------------------------------------------------------------
function item_undead_boots:PlayEffects( origin, direction )
	-- Get Resources
