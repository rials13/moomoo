...
--------------------------------------------------------------------------------
-- Passive Modifiers
function item_arcanite:GetIntrinsicModifierName()
    return "item_prismatic_modifier_passive"
end
--------------------------------------------------------------------------------

function item_arcanite:OnSpellStart()
    -- unit identifier
...
function item_arcanite:PlayEffects()
	local particle_cast = "particles/econ/events/ti10/mekanism_ti10.vpcf"
