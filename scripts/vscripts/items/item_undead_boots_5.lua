...
--------------------------------------------------------------------------------
function item_undead_boots_5:PlayEffects( origin, direction )
	-- Get Resources
