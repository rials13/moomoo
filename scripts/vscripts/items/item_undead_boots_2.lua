...
--------------------------------------------------------------------------------
function item_undead_boots_2:PlayEffects( origin, direction )
	-- Get Resources
