...
--------------------------------------------------------------------------------
function item_undead_boots_4:PlayEffects( origin, direction )
	-- Get Resources
